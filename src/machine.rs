...
impl Machine {
    ...
    pub fn print(&self) {
        if (self.mem.read(0xFF02) & 0b10000000) > 0 {
            println!("transfer")
        }
        // print!("{}", self.mem.read(0xFF01 as usize));
    }
        ...
        match x {
                ...
                match z {
                    0 => {
                        match y {
                            ...
                            1 => {
                                ...
                                self.mem
                                    .write(nn, (self.reg.get_reg16(Reg16::SP) & 0x00FF) as u8);
                                self.mem.write(
                                    nn,
                    ...
                    4 => {
                        ...
                        if y == 6 {
                            self.mem.write(
                                self.reg.get_reg16(Reg16::HL),
                                self.mem.read(self.reg.get_reg16(Reg16::HL)) + 1,
                            );
                            return;
                        }
                    ...
                    6 => {
                        ...
                        if y == 6 {
                            self.mem.write(self.reg.get_reg16(Reg16::HL), n);
                            return;
                        }
            ...
            1 => {
                if (z == 6) & (y == 6) {
                    ...
                    if y == 6 {
                        if z == 6 {
                            let n = self.mem.read(self.reg.get_reg16(Reg16::HL));
                            self.mem.write(self.reg.get_reg16(Reg16::HL), n);
                            return;
                        }
                        let src = self.mem.read(self.reg.get_reg16(Reg16::HL));
                        let dst = match z {
                            0 => Reg8::B,
                            1 => Reg8::C,
                            2 => Reg8::D,
            ...
            2 => {
                ...
                if z != 6 {
                    ...
                    val = self.mem.read(self.reg.get_reg16(Reg16::HL));
                }
                    ...
                    0 => {
                        match y {
                            0..=3 => {
                                ...
                                if check_cc!(y) {
                                    let lsb = self.mem.read(self.reg.get_reg16(Reg16::SP));
                                    let msb = self.mem.read(self.reg.get_reg16(Reg16::SP) + 1);
                            ...
                            4 => {
                                ...
                                let a = self.reg.get_reg8(Reg8::A);
                                let n = self.fetch();
                                self.mem.write(n as u16 + 0xFF00, a);
                            }
                            ...
                            6 => {
                                // LD A, (0xFF00 + n)
                                let n = self.fetch();
                                self.reg.set_reg8(Reg8::A, self.mem.read(n as u16 + 0xFF00));
                            }
                    ...
                    1 => {
                        match q {
                            0 => {
                                // POP rr
                                let sp = self.reg.get_reg16(Reg16::SP);
                                let lsb = self.mem.read(sp);
                                let msb = self.mem.read(sp + 1);
                                let rr = match_rp2!(p);
                    ...
                    2 => {
                        match y {
                            ...
                            4 => {
                                ...
                                self.mem.write(c as u16 + 0xFF00, a);
                            }
                            ...
                            6 => {
                                // LD A, (0xFF00 + C)
                                let c = self.reg.get_reg8(Reg8::C);
                                self.reg.set_reg8(Reg8::A, self.mem.read(c as u16 + 0xFF00));
                            }
                            ...
                            7 => {
                                ...
                                let nn_msb = self.fetch();
                                let nn = (nn_msb as u16) << 8 | nn_lsb as u16;
                                self.reg.set_reg8(Reg8::A, self.mem.read(nn));
                            }
                        ...
                        match y {
                            0..=3 => {
                                ...
                                if check_cc!(y) {
                                    ...
                                    self.mem.write(sp - 1, (self.pc >> 8) as u8);
                                    self.mem.write(sp - 2, (self.pc & 0xFF) as u8);
                                    sp -= 2;
                    ...
                    5 => {
                        match q {
                            0 => {
                                ...
                                let mut sp = self.reg.get_reg16(Reg16::SP);
                                self.mem.write(sp - 1, (reg >> 8) as u8);
                                self.mem.write(sp - 2, (reg & 0xFF) as u8);
                                sp -= 2;
                                self.reg.set_reg16(Reg16::SP, sp);
                            }
    ...
    fn execute_cb(&mut self, opcode: u8) {
        ...
        match x {
            0 => {
                ...
                let regv = match z {
                    6 => self.mem.read(self.reg.get_reg16(Reg16::HL)),
                ...
                match z {
                    6 => self.mem.write(self.reg.get_reg16(Reg16::HL), n_regv),
